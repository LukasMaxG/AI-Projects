...
## Current Status: MVP (Phase 2.2) - ✅ Refined & Connected
The application has achieved "Master Sommelier" level depth and now features professional-grade typography and smart external connectivity.
...
2.  **Premium Experience**:
    *   **Branding**: "Wine & Gold" aesthetic.
    *   **Typography**: Paired *Playfair Display* (Serif) with *Inter* (Sans) to achieve "Bootstrap-level" readability and professionalism.
...
3.  **Advanced Intelligence (The "Sommelier" Upgrade)**:
    ...
    *   **Service**: Specific glassware recommendations, decanting times, and temperature.
    *   **Heritage & Trivia**: Deep dive into winery origins, "Legendary Years," and fun facts.
4.  **Smart Connectivity**:
    *   **Direct Access**: Tapping the hero image directly opens the official winery website.
    *   **Visual Fallback**: Robust logic prioritizes User Scan > AI-found Image > Elegant Stock Photo.
